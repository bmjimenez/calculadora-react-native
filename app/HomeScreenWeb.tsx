...
export default function HomeScreen() {
  return (
    <View>
      ...
      <div align="center"><Link href="/AppNative"><img align="center" width="480" height="480" src="https://img.icons8.com/color/480/apple-calculator.png" alt="apple-calculator"/></Link></div>
